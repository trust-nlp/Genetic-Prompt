...
parser.add_argument("--top_p", default=0.95, type=float, help="")
...
parser.add_argument("--max_tokens", default=1024, type=int, help="")
...
if args.dataset in ['chemprot']:
    ...
    args.label_def = {
        "Conjunction": "Entities as similar role or use/incorporate with.",
    ...
    args.label_def = {
        "Cause-Effect": "An entity causes an effect to another entity",
    ...
    args.attributes = ["length", "voice", "polarity", "interaction_verb", "modifier", "drug_mentions", "Entity Proximity"]
    args.label_def = {
    ...
    args.domain = "Stack Exchange question"
        ...
        for j in range(args.n_sample):
            ...
            if args.dataset == 'chemprot':
                ...
                prompt_input += f"""
                                    ...
                                    The sentence must discuss about the {args.entity[0]} and {args.entity[1]} with the relation {label_def}.\n 
                                        """
                ...
                prompt_input += f"""
                                    ...
                                    The question-answer pair should follow the format below: \n
                                        """
                prompt_input += in_context_input
                ...
                prompt_input += f"""
                                    ...
                                    The abstract and summary should follow the format below: \n
                                    """
                prompt_input += in_context_input
                prompt_input += f'Output:'
            elif args.dataset == "mediqa":
                ...
                prompt_input += f"""
                                    ...
                                    The question and summary should follow the format below: \n 
                                    """
                prompt_input += in_context_input
                prompt_input += f'Output:'
            elif args.dataset == "stackexchange":
                prompt_input = f"Suppose you are a writer for {args.domain}. Please write a synthetic {class_name} {args.domain}.\n"
                prompt_input += in_context_input
                prompt_input += f'Output:'
                ...
                prompt_input += in_context_input
                prompt_input += f'Output:'
            elif args.dataset in ["yelp", "sst-2"]:
                prompt_input = f"Suppose you are a writer for {args.domain}. Please write a synthetic {class_name} {args.domain}. "
                prompt_input += in_context_input
                prompt_input += f'Output:'
            else:
